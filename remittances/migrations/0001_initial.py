# Generated by Django 2.0.6 on 2018-07-25 05:21
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('type', models.CharField(choices=[('A', '10 Pesos'), ('B', '12 Pesos'), ('C', '15 Pesos')], max_length=1)),
            ],
            options={
                'abstract': False,
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('shift', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to='remittances.BeepShift')),
            ],
            options={
                'abstract': False,
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.CharField(choices=[('O', 'Ongoing'), ('F', 'Finished')], default='O', max_length=1)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('archived_at', models.DateTimeField(blank=True, null=True)),
                ('archiver', models.CharField(blank=True, max_length=32)),
                ('driver', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='driver_name', to='members.Driver')),
            ],
            options={
                'abstract': False,
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('total', models.DecimalField(decimal_places=10, default=0, max_digits=19)),
                ('km_from', models.DecimalField(decimal_places=10, default=0, max_digits=19)),
                ('km_to', models.DecimalField(decimal_places=10, default=0, max_digits=19)),
                ('discrepancy', models.DecimalField(decimal_places=10, default=0, max_digits=19)),
                ('created', models.DateTimeField(editable=False)),
                ('modified', models.DateTimeField(null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created', models.DateTimeField(editable=False)),
                ('modified', models.DateTimeField(null=True)),
                ('schedule', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='remittances.Schedule')),
