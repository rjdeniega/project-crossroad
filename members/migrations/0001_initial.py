    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('educational_attainment', models.CharField(choices=[('P', 'Preschool'), ('E', 'Elementary'), ('H', 'HighSchool'), ('V', 'Vocational'), ('B', 'Bachelors Degree'), ('M', 'Masters Degree'), ('D', 'Doctorate')], max_length=1)),
